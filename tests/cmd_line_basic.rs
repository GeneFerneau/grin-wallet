...
fn command_line_test_impl(test_dir: &str) -> Result<(), grin_wallet_controller::Error> {
	...
	let file_name = format!(
		"{}/wallet1/slatepack/0436430c-2b02-624c-2032-570501212b06.A1.slatepack",
		test_dir
	);
	...
	let file_name = format!(
		"{}/wallet2/slatepack/0436430c-2b02-624c-2032-570501212b06.A2.slatepack",
		test_dir
	);
	...
	let file_name = format!(
		"{}/wallet1/slatepack/0436430c-2b02-624c-2032-570501212b06.A3.slatepack",
		test_dir
	);
	...
	let file_name = format!(
		"{}/wallet2/slatepack/0436430c-2b02-624c-2032-570501212b07.A1.slatepack",
		test_dir
	);
	...
	let file_name = format!(
		"{}/wallet1/slatepack/0436430c-2b02-624c-2032-570501212b07.A2.slatepack",
		test_dir
	);
	...
	let file_name = format!(
		"{}/wallet2/slatepack/0436430c-2b02-624c-2032-570501212b07.A3.slatepack",
		test_dir
	);
	...
	let file_name = format!(
		"{}/wallet1/slatepack/0436430c-2b02-624c-2032-570501212b07.A4.slatepack",
		test_dir
	);
